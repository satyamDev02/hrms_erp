...
export const createAttendance = async (data) => {
    try {
        ...
        let config = {
            method: 'post',
            url: API_URL + `/attendance/create/update`,
            headers: {
...
export const fetchAttendanceList = async (queryParams) => {
    try {
        const token = localStorage.getItem('access_token');
...
export const fetchAttendanceDetails = async (queryParams) => {
    try {
        const token = localStorage.getItem('access_token');
        const query = queryParams ? objectToQueryString(queryParams) : '';
        let config = {
            method: 'post',
            url: API_URL + `/attendance/details` + query,
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${token}`
            },
...
export const fetchAttendanceSummary = async (queryParams) => {
    try {
        ...
        let config = {
            method: 'post',
            url: API_URL + `/attendance/summary` + query,
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${token}`
            },
...
export const updateAttendanceStatusApi = async (data) => {
    try {
        ...
        let config = {
            method: 'post',
            url: API_URL + `/attendance/status/update`,
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${token}`
            },
