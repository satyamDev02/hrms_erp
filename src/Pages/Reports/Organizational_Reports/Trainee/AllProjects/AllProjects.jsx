...
const AllProjects = () => {
    ...
    const TotalLeaves = [
        { name: 'Completed', value: 100, fill: '#400F6F' }, // Purple color 
        { name: 'Pending', value: 45, fill: '#765C8E' },
        { name: 'On Hold', value: 10, fill: '#A18FB2' }, 
        { name: 'Cancelled', value: 10, fill: '#CFADE9' }, // Red color
        { name: 'Ongoing', value: 5, fill: '#EBE7EE' }, // Red color 
        
    ];
    
    const totalProject = TotalLeaves[0].value + TotalLeaves[1].value + TotalLeaves[2].value + TotalLeaves[3].value + TotalLeaves[4].value;
        ...
        <>
            ...
            <div className="tr_CartPie" ref={printRef} >
                <div className="TotalLeaves_Project">
                    ...
                    <div className="pieChart_pro" style={{marginTop:"30px"}}>
                        <ResponsiveContainer>
                            <PieChart>
