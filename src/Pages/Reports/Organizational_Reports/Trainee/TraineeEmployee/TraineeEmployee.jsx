...
const TraineeEmployee = () => {
    ...
    const TotalLeaves = [
        { name: 'Functional Training', value: 100, fill: '#400F6F' }, // Purple color 
        { name: 'Technical Training ', value: 45, fill: '#765C8E' },
        { name: 'Fire Drills Training ', value: 10, fill: '#A18FB2' },
        { name: 'Health and safety training', value: 5, fill: '#CFADE9' },
        { name: 'Leadership training', value: 1, fill: '#CFADE9' }

    ];

    const totalProject = TotalLeaves[0].value + TotalLeaves[1].value + TotalLeaves[2].value + TotalLeaves[3].value + TotalLeaves[3].value
    const navigate = useNavigate(); // Use useNavigate here
    const [selectedIndex, setSelectedIndex] = useState(1);
    const [showDropdown, setShowDropdown] = useState(false);
    const [activetab, setActivetab] = useState('Trainee Employee');
    ...
    return (
        <>
            ...
            <div className="projec_Balance_second_title">
                <h3>All Trainee Employees  ({totalProject})</h3>
                ...
                <div className="UpcomingStatus">
                    ...
                    <div className="trainingList">
                        <div className="content_list">
                            <div className="svg_">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#5d369f" fill="none">
                                    <path d="M7 17L7 13" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
                                    <path d="M12 17L12 7" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
                                    <path d="M17 17L17 11" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
                                    <path d="M2.5 12C2.5 7.52166 2.5 5.28249 3.89124 3.89124C5.28249 2.5 7.52166 2.5 12 2.5C16.4783 2.5 18.7175 2.5 20.1088 3.89124C21.5 5.28249 21.5 7.52166 21.5 12C21.5 16.4783 21.5 18.7175 20.1088 20.1088C18.7175 21.5 16.4783 21.5 12 21.5C7.52166 21.5 5.28249 21.5 3.89124 20.1088C2.5 18.7175 2.5 16.4783 2.5 12Z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round" />
                            ...
                            <div className="text_2">
                                <h5>Conflict resolution training</h5>
...
export default TraineeEmployee;