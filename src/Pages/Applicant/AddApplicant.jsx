...
import AddNewApplicantForm from "./AddNewApplicantForm.jsx";
    ...
    <>
      ...
      <div className="employee-form">
        <div className="top-bar">
          ...
          <Link to={"/applicant_list"} className="close_nav">
            <TfiClose />
          </Link>
          {/* <span className="close_nav" onClick={JobList}>
            <TfiClose />
          </span> */}
          <div className="">
        ...
        <div className="form-content">
          <AddNewApplicantForm onSubmit={handleSubmit} />
        </div>
      </div>
    </>
  );
