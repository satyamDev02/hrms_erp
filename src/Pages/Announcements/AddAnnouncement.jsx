...
import AddNewAnnouncementForm from './AddNewAnnouncementForm.jsx';
        ...
        <>
            ...
            <div className="employee-form">
                <div className="top-bar">
                    <h2><div className='span'><HiUserPlus /></div>
                    {id ? "Edit Announcement" : "Add Announcement"}
                   </h2>
                    <Link to={"/announcements"} className="close_nav">
                        <TfiClose />
                    </Link>
                    <div className="">
                ...
                <div className="form-content">
                    <AddNewAnnouncementForm onSubmit={handleSubmit} />
                </div>
            </div>
        </>
    );
