...
import './DashboardPerformanceStats.scss'

const DashboardPerformanceStats = ({ apiData }) => {
  ...
  return (
    <div className="main_performance_stats_dash">
      <div className="header_stats_dash">
        <span>
...
export default DashboardPerformanceStats;
