...
import AddNewTrainingForm from './AddNewTrainingForm.jsx';
        ...
        <>
            <div className="employee-form">
                <div className="top-bar">
                    ...
                    </div>{id ? "Edit Training" : "Add Training"}</h2>
                    <Link to={"/training"} className="close_nav">
                        <TfiClose />
                    </Link>
                    <div className="">
                ...
                <div className="form-content">
                    <AddNewTrainingForm onSubmit={handleSubmit} />
                </div>
            </div>
        </>
    );
