...
import { filterEmployeeOptions } from "../../../utils/FilterConstant.js";
import "./AllEmployeeList.scss";
import Loader from "../../../utils/common/Loader.jsx";
...
const AllEmployeeList = () => {
  ...
  const handleUpdateStatus = () => {
    const sendData = {
      employee_id: statusObj?.id,
      employee_status: statusObj?.status,
    };
  ...
  useEffect(() => {
    if (searchTrigger) fetchEmployeeList();
  }, [searchTrigger]);
  ...
  const handleRowClicked = (item) => {
    navigate(`/employee-details/${item?.user_id}`);
  };
  return (
    <div id="allEmp">
      <ConfirmPopup
        ...
        <div className="EmpOn_header">
          <div className="top-bar">
            <h2>
              ...
              All Employee list <p>{totalItems} total</p>
            </h2>
            <div className="Emp_Head_Right">
              <div className="addEmp" onClick={handleAddNewEmployee}>
                <p>
                  <span>
                    <IoMdAdd />
                  </span>{" "}
      ...
      <div className="EmpOn_Second_Head">
        ...
        <div className="right">
          ...
          <SearchBox
            onSearch={onSearch}
            placeholder="Search Employee Name, Phone Number, Email..."
          />
                          ...
                          <div className="status-dropdown">
                            <div key={index} className="status-container">
                              <div ref={statusDropDown.buttonRef}>
                                <div
                                  className={`status-display ${item?.employee_status
                                ...
                                >
                                  <span
                                    className={`left_dot ${item?.employee_status
                                      ? item?.employee_status
                                        .toLowerCase()
                                        .replace(" ", "-")
                                      : ""
                                  ...
                                  >
                                    {employeeStatusOptions.map((status) => (
                                      <div
                                        ...
                                        onClick={() =>
                                          handleStatusChange(item?.user_id, status)
                                        }
                                      >
                                        {status}
                                      </div>
