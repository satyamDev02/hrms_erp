...
const Designation = () => {
  ...
  const totalItems = designationData?.data?.count || 0;

  const importDropDown = OutsideClick();
  const newDesignationPopup = OutsideClick();
  ...
  useEffect(() => {
    if (searchTrigger) fetchDesignationList();
  }, [searchTrigger]);
  ...
  const handleRowClicked = (jobs) => {
    navigate(`/designationdeatils/${jobs?.id}`);
  };

  return (
    <div>
      {newDesignationPopup?.isOpen && (
        <AddNewDesignation
          ClosePop={newDesignationPopup.handleToggle}
          refBox={newDesignationPopup?.ref}
        ...
        <div className="EmpOn_header">
          <div className="top-bar">
            <h2>
              ...
              All Designation list <p>{totalItems} total</p>
            </h2>
            <div className="Emp_Head_Right">
              <div
                className="addEmp"
                onClick={newDesignationPopup.handleToggle}
                ref={newDesignationPopup.buttonRef}
              >
                <p>
                  <span>
                    <IoMdAdd />
              ...
              <div className="menu_head" onClick={importDropDown.handleToggle}>
      ...
      <div className="EmpOn_Second_Head" id="searchhead">
        ...
        <div className="right">
          ...
          <SearchBox
            onSearch={onSearch}
            placeholder="Search Designation Name, Department Name..."
          />
        ...
        <div className="employee-table" id="Small_employee_table">
          {designationLoading ? (
            ...
            <table id="Small_table" className="tableD">
              ...
              <tbody>
                {designationLists.length > 0 ? (
                  designationLists.map((item, index) => (
                  ...
                  <tr>
                    <td colSpan="4" className="not_found_td">
                      <NoDataFound />
                    </td>
                  </tr>
                )}
